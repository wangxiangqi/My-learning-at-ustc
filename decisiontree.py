#implement ID3 algorithm with sklearn
# based on the Kaggle competation
"""
...
def splitDataSet(dataSet,axis,value):
    ...
    for featVec in dataSet:
        if featVec[axis]==value:
            ...
            #print("reduceFeatVec is ",reduceFeatVec)
